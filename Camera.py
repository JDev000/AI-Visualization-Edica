...
target_objects = ['person', 'cell phone', 'cup', 'bottle', 'knife', 'fork', 'spoon', 'bowl', 'dining table', 'scissors',
                  'keyboard', 'remote']
        ...
        if row[4] >= 0.5:
            ...
            if object_name in target_objects:  # Check if detected object is in the target list
                ...
                if object_name == 'person':
                    color = (0, 255, 0)  # Green for tao haha
                elif object_name == 'cell phone':
                    color = (255, 0, 0)  # Blue for Iphone ni jirrum
                else:
                ...
                cv2.putText(img, f'{object_name} {row[4]:.2f}', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 1)
